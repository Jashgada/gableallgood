...
const CAMPUSEXP: IPlatform[] = [
    ...
    },
    {
        ...
        info: "In order for the Undergraduate Student Government to truly represent all students, it is important to have a visible and accessible avenue for communication. Through the usage of campus screens, including those at branch campuses, SG in collaboration with TUC and MainStreet Operations will create biweekly and monthly reports that will be shared with students to keep them updated with upcoming projects, events, and meetings.",
        ...
        plan:"Through combined efforts between G+A and USG Media Directors and Press Secretary, biweekly updates through social media channels and monthly updates will be submitted to TUC and MainStreet Operations Directors to broadcast on screens in TUC, Dining Halls, Residence Halls, both Branch Campuses, and the University Recreation Center. These updates will include: meeting times and locations, upcoming events, applications, board events, and contact information for the SG Instagram and website. ",
        color:"cherry"
    }
]
...
const ACTION: IPlatform[] = [
    {
        ...
        plan:"In order to create this conference, we plan to work alongside parties and offices such as the Office of Ethnic Programs and Services, Bearcat Support Network, and the Office of Equity and Inclusion, as well as identity based centers, such as the Women’s Center, the LGBTQ+ Center, Wellness Center, and the African American Cultural Resource Center to elevate the missions, voices, and resources to all of the student body. This week-long event will include sessions to learn about intersectionality and educate peers on critical information about identities and backgrounds as well as events to celebrate what makes us uniquely us. The event will be conducted in a hybrid format, a combination of hybrid and in-person sessions, held at varying times each day to ensure all students are able to participate around their individual schedules.",
        color:"yellowish"
    },
    {
        ...
        plan:"Utilize SG Directors and UC Faculty members like Carol Tonge Mack, to share the training to all corners of UC to reach different organizations and services on campus. While working with these parties we will encourage organizations to include this training as a part of their new member process and / or as a part of their yearly organization RESET. ",
        color:"yellowish"
    },
    {
    ...
    },
    {
        ...
        plan:"Our plan is to establish a page on the Student Government Website dedicated to having the student voice heard.  Currently, there is no platform for students within Student Government and for those who are not to provide input on what they would like to see happen on this campus. On this page, we will create a section for students to (1) suggest initiatives/changes they would like to see, (2) provide feedback on past or ongoing Student Government initiatives, and (3) request contact information of Student Government officials who they would like to reach out to for further collaboration. Student Government works for you and in order to have the student voice heard, we must establish a platform for students to go to with their suggestions.",
        color:"yellowish"
    }
]
...
const SUSTAINABILITY: IPlatform[] = [
    {
        ...
        info: "Let’s promote sustainable practice while eating on and around campus from day one by creating and dispersing a supply of reusable ware and straws to students. Creating a greener university is a lifelong commitment for this university and by targeting our dining halls on campus, we can work to create sustainable change in our plastic usage. ",
        ...
        plan:"In order to begin this process, we will partner with UC Food Services and UC Sustainability to identify reusable tupperware and straw options that would be best suited for our students. In addition, SG will work alongside Residential Education and Development (RED) and Housing Services to distribute these items to on-campus residents at the beginning of the Fall 2021 Semester. Additional sets will be available for students to pick up during Welcome Week and early Fall Semester events.",
        color:"darkmaroon"
    },
    {
        name: "Everyone Eats - Bearcat Pantry Fuel Fridge",
        info: "In between classes and need a snack? Or heading home for the night and haven’t gone grocery shopping yet? We get it! Inspired by Cincinnati Local Fridges, SG with support of the Bearcat Food Recovery Network, UC Wellness Center, and Dining Services to add a communal campus fridge for students to take what they need and give what they can. Not only will we work to bridge the gap between food insecurity on campus, but lower food waste. ",
...
const VARSITY: IPlatform[] = [
    {
        ...
        We will continue the work of Hannah Markel’s and Dr. Sojka’s work and legacy of the Inspire Equip Connect Program to further positively affect the next generations of Bearcats to come. This program will be expanded to have more members of the community trained and able to attend IEC sessions. 
    ...
    },
    {
        ...
        impact:`Expanding Bearcat Fridays means all members of the UC community are invited and highly encouraged to partake in the newest addition of this experience!`,
